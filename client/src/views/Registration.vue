            ...
            <div class="signInBlock_form">
              <form>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="username" id="username" aria-describedby="emailHelp" placeholder="Enter email" v-model="login">
                  <small id="emailHelp" class="form-text text-muted" :class="{'invalid-feedbak': displayError}">{{loginErrorMessage}}</small>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="password" id="password check" placeholder="Password" v-model="repeatedPassword">
                </div>
